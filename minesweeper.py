...
def set_mines1(r_, col_):
    ...
    # Generate candidates of r, col
    pool = [*range(0, n*n, 1)]  

    try:
        pool.remove(r_*n + col_)
    except:
...
def instructions(flags, mines_no):
    print("Instructions:")
    ...
    try:
        print("\nNumber of Mines left: ", mines_no - len(flags))
    except:
        print("Number of Mines NOT available")
...
if __name__ == "__main__":
    ...
    # Number of mines
    # mines_no = 8
    mines_no = input("number of mines:")
    mines_no = int(mines_no)
    ...
    while not over:
        ...
        if len(inp) == 2:
            ...
            try: 
                ...
                # Ensure that the first loop does not land on mine
                if nbLoop == 0:
                    r = val[0]-1
                    col = val[1]-1
                    set_mines1(r, col)
